...
export default function Portfolio() {
    return (
        <section className="lg:py-24 lg:px-20 2xl:px-32 py-20 px-4 border-b border-t border-gray-500 max-md:h-full"
            id="portfolio">
            <div className="flex flex-col md:gap-10 lg:items-end text-center lg:justify-end lg:text-right">
                ...
                <div className="flex flex-wrap items-center justify-center gap-16 mt-16 lg:mt-10">
