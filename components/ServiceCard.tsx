...
export default function ServiceCard({ image, title, description }: ServiceCardProps) {
    return (
        <div className="cursor-default flex flex-col  gap-3 bg-white p-4 max-md:w-[340px] w-[295px] h-[175px] hover:bg-secondary duration-500 ease-in-out text-primary hover:text-white">
